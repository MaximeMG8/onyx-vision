...
const EditProjectDialog = ({ isOpen, onClose, project, onSave }: EditProjectDialogProps) => {
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="flex flex-col items-center gap-3">
            <button
              ...
              className="relative w-20 h-20 rounded-full border border-white/20 overflow-hidden group transition-all hover:border-white/40"
            >
              {imagePreview ? (
                <img
                  src={imagePreview}
            ...
            <Popover>
              <PopoverTrigger asChild>
                <Button
                  variant="ghost"
                  className={cn(
                    "w-full justify-start text-left font-extralight bg-transparent border-0 border-b border-white/20 rounded-none px-0 py-3 h-auto hover:bg-transparent hover:border-white/50",
                    !deadline && "text-white/20"
                  )}
                >
                ...
                return (
                  <button
                    ...
                    className={cn(
                      ...
                      isSelected && "ring-1 ring-offset-2 ring-offset-black ring-white/50"
                    )}
                  ...
                  >
                    {isSelected && (
                      <div className={cn(
                        ...
                        color === 'white' || color === 'yellow' ? 'bg-black' : 'bg-white'
                      )} />
                    )}
                  </button>
                );
