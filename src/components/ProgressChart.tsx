...
const ProgressChart = ({ deposits, targetAmount, accentColor = "0 0% 100%" }: ProgressChartProps) => {
  ...
  return (
    <div className="w-full">
      ...
      <div 
        className="h-[220px] w-full rounded-lg border border-border/30 p-4"
        style={{ 
        ...
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
            ...
            <XAxis
              ...
              axisLine={false}
              tickLine={false}
              tick={{ fill: 'hsl(var(--muted-foreground))', fontSize: 9, fontWeight: 300 }}
              dy={10}
